package ru.geekbrains.seminar_3.exercise_2;
...
public class Main {
    ...
    /**
     * Метод compareArrays предназначен для сравнения массивов различных типов данных по длине и содержанию.
